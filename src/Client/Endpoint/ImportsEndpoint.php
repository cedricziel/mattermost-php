...
class ImportsEndpoint
{
    ...
    public function listImports(
        ...
        $uri = $this->buildUri('/api/v4/imports', $pathParameters, $queryParameters);
    ...
    public function deleteImport(
        ...
        $pathParameters['import_name'] = $import_name;

        // build URI through path and query parameters
        $uri = $this->buildUri('/api/v4/imports/{import_name}', $pathParameters, $queryParameters);
