...
class PluginsEndpoint
{
    ...
    public function installPluginFromUrl(
        ...
        /** Set to 'true' to overwrite a previously installed plugin with the same ID, if any */
        ?string $force = null,
    ): \CedricZiel\MattermostPhp\Client\Model\StatusOK|\CedricZiel\MattermostPhp\Client\Model\DefaultBadRequestResponse|\CedricZiel\MattermostPhp\Client\Model\DefaultForbiddenResponse|\CedricZiel\MattermostPhp\Client\Model\DefaultNotImplementedResponse|\CedricZiel\MattermostPhp\Client\Response\BinaryResponse {
        $pathParameters = [];
        $queryParameters = [];
